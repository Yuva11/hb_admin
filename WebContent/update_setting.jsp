	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Update delivery charges and distance </h2>
			<div align="right"
				style="color: white; font-family: serif; padding: 0px;">
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
	</div>
	
	<form action="update_delivery_distance.jsp" method="get" name="f1" 	onsubmit="return validation()">
	  		<table>
	  			<%
			       ...
			       try
	              {
	      		ps3 = con.prepareStatement("select * from  setting");
