	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Update Delivery Token No:-</h2>
			<div align="right"
				style="color: white; font-family: serif; padding: 0px;">
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
			
			</div>
	<form action="updatetokenno.jsp" method="get" name="f1" 	onsubmit="return validation()">
	    
		
			<table><!-- <tr><td></td>
			<td align="right"><a href="selectoutlet.jsp"><p align="right" style="color: darkblue">Show Token No.</p></a></td></tr>
 -->		<tr><td>	
    ...
    String merchantbranch_name=request.getParameter("merchantbranch_name");
     ...
     %>
       ...
       <option value='-1'><%=merchantbranch_name %></option> 
