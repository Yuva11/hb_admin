...
<body >
  ...
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
	...
	<form action="insertcoupancode.jsp" method="get" name="f1" 	onsubmit="return validation()">
	  		<table>	
			<tr>		
			<td>Enter coupon_code</td> <td><input type="text" name="name1"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter percentage</td> <td><input type="text" name="name2"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter max_value</td> <td><input type="text" name="name3"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter start_date</td> <td> <input type="text" name="name4" id="datepicker"
					style="width: 120px;" /><img src="images/ffffff.jpeg" height="25px"
					width="25px" style="margin-top: -9px;" /></td></tr>


						<tr>		
			<td>Enter end_date</td> <td> <input type="text" name="name5" id="datepicker1"
					style="width: 120px;" /><img src="images/ffffff.jpeg" height="25px"
					width="25px" style="margin-top: -9px;" /></td></tr>
					
						<tr>		
			<td>Enter city</td> <td><input type="text" name="name6"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
 ...
 while(rs.next()){
     ...
     %>
      ...
      <option value='-1'></option>  
				...
				<td>Enter Minimum Order value</td> <td><input type="text" name="name7"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					<%long i=0L; %>
						<input type="hidden" name="name8" value="<%=i %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" />
					
						<td>Enter Maximum usage</td> <td><input type="text" name="name9"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
