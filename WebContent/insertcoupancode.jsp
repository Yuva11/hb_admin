...
<body >
				...
				<%
	              ...
	              try
	              {
	      		ps3 = con.prepareStatement("insert into discountcoupon values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
				ps3.setLong(1,c);
				...
				ps3.setLong(8,Long.parseLong(state));
				ps3.setDouble(9,Double.parseDouble(name7));
				ps3.setLong(10,Long.parseLong(name8));
				ps3.setLong(11,Long.parseLong(name9));
				ps3.setLong(12,Long.parseLong(country));
				ps3.setInt(13, type);
