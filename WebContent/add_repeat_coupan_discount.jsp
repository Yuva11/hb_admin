	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading" style="background-color: darkred; padding: 5px;">
				Add Coupon Code Details for repeat order customer</h2>
			<div align="right"
				style="color: white; font-family: serif; padding: 0px;">
				<li class="logout"><a href='logout.jsp'
					style="font-size: 13px"><b>Logout</b></a></li>
			</div>
			<form action="insertRepeatCouponCode.jsp" method="get" name="f1"
				onsubmit="return validation()">
				<table>
					<tr>
						<td><input type="number" name="orderNumber" class="input_text"
					...
					<tr>
						<td>
							<input type="number" name="discountValue" class="input_text"
							style="width: 139px; padding: 4px; margin-bottom: 5px"
					...
					<tr>
						<td>
							<textarea  placeholder="Discount Message (To be shown to the customer)" name="discountMessage" class="input_text"
								style="width: 139px; padding: 4px; margin-bottom: 5px"></textarea></td>
					</tr>
