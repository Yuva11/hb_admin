...
<body >
	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Reconciled, Settled details Update </h2>
			<div align="right"
  ...
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
			...
			try {
				ps1 = con.prepareStatement("SELECT  * FROM payment_recon where order_id=?");
				ps1.setString(1, orderid);
				rs1 = ps1.executeQuery();
				if(rs1.next()) 
				{
			%>
	<form action="setalment_update.jsp" method="get" name="f1" 	onsubmit="return validation()">
			...
			<select type="text" name="name1"  class="input_text"  
					...
					<option> Not Yet</option>
						...
						<tr>		
			<td>Order Id</td> <td><input type="text" name="name2" value="<%=rs1.getString(3) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
					
					
						<tr>		
			<td>Order Status</td> <td><input type="text" name="name3" value="<%=rs1.getString(4) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
...
<input type="hidden" name="name4" value="<%=rs1.getString(5) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" />
			...
			<td>Merchant branch Name</td> <td> <input type="text"  value="<%=branch_name%>" class="input_text"  
					...
					<input type="hidden" name="name5" value="<%=rs1.getString(6) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" />
					
						<tr>		
			<td>Payment ID</td> <td><input type="text" name="name6" value="<%=rs1.getString(7) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
					
					<tr>		
			<td>Payment  Method</td> <td><input type="text" name="name7" value="<%=rs1.getString(8) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
			...
			<td>Deal  Name</td> <td><input type="text"   value="<%=deal_name%>" class="input_text"  
					...
					<input type="hidden" name="name8" value="<%=rs1.getString(9) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" />
			...
			<table style="width: 600px">	
						...
						<tr>		
			<td>Payment Status</td> <td><input type="text" name="name9"  value="<%=rs1.getString(10) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Order Amount </td> <td><input type="text" name="name10"  value="<%=rs1.getDouble(11) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>HB Discount Value </td> <td> <input type="text" name="name11" value="<%=rs1.getDouble(12) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>

<% double d=0.0; %>
						<tr>		
			<td>Received Amount from PG</td> <td> <input type="text" value="<%=rs1.getDouble(13) %>" name="name12"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>PG Commission </td> <td><input type="text" name="name13" value="<%=rs1.getDouble(14) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>HB Received Amount  </td> <td><input type="text" name="name14" value="<%=rs1.getDouble(15) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
					
						<tr>		
			<td>HB Commission  </td> <td><input type="text" name="name15" value="<%=rs1.getDouble(16) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
