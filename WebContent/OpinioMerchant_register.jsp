	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Merchant Register For Opinio </h2>
			<div align="right"
				style="color: white; font-family: serif; padding: 0px;">
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
	</div>
	<form action="merchantregisterforopinio_useapi.jsp" method="get" name="f1" 	onsubmit="return validation()">
	  		<table>	
			</tr>
					
	<td>Search Merchant Branch Name</td> <td>
	 <select name='country' name="country" onchange="showState(this.value)" style="width:150px;margin-left: 8px;">  
