...
<script>
	function validation() {
		...
		if (document.f1.smstemp.value == 0) 
		{
			alert("Please Enter the message..");
			document.f1.smstemp.focus();
			return false;
		}
	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Send Sms Coupon Code to Customer </h2>
			<div align="right"
				style="color: white; font-family: serif; padding: 0px;">
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
	</div>
	<form action="sendsmstoallcustomer.jsp" method="get" name="f1" 	onsubmit="return validation()">
	  		<table>	
	<%-- 		<tr>		
			<td>Enter Coupon Code Percentage</td> <td><input type="text" name="name1"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
	
						<td> Select Coupon Code</td> <td>
 ...
 */ Statement stmt = con.createStatement();  
 ResultSet rs = stmt.executeQuery("Select * from discountcoupon");
 while(rs.next()){
     %>
 ...
 --%> 	<tr>		
			<td>Enter SMS Template</td> <td> <textarea rows="6" cols="70" name="smstemp" style="margin-left: 7px;">
				...
				<br /> 
				<tr><td></td> <td><input type="submit" value="Send SMS" style="margin-left: 11px;" /></td></tr> <br /> <br />
