...
<body >
	...
	<div class="col span_1_of_4" style="width: 100%">
		<div class="right">
			<h2 class="heading"
				...
				Add Token number for Merchant</h2>
			<div align="right"
  ...
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
   ...
   <strong><b style="font-family: serif;margin-top: 10px;font-size: 11px;"><img src="images/Delete_Icon.png" height="15x" width="20px"></img><a href="deletesearchproduct.jsp" style="padding: 8px;background-color: azure">Delete order</a></b></strong> -->
			...
			<br />
			<%
			String ss1=request.getParameter("name1");
			String ss2=request.getParameter("name2");
			
			%>
			 <label class="store" style="width: 22%; font-size: 14px; font-family: inherit; background-color: aliceblue; padding: 6px 13px;">
			Enter Token  No.</label>
			<form action="updatetokennoformerchant.jsp" method="post" name="f1" 	onsubmit="return validation()">
				
				<input type="text" name="name1"  class="input_text"  
					style="width: 139px; padding: 4px;" />
					
						<input type="hidden" name="name2"  value="<%=ss1 %>"
					style="width: 139px; padding: 4px;" />
						<input type="hidden" name="name3"   value="<%= ss2%>"
					style="width: 139px; padding: 4px;" />
