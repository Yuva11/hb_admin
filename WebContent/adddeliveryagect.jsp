 ...
 <link rel="stylesheet" type="text/css" href="css/style3.css" />
   ...
   <script>
	jQuery(function(){
     ...
     <script>
	jQuery(function(){
		$("#country3").autocomplete("list4.jsp");
	});
   </script>
...
<body >
  ...
  <li class="logout" ><a href='logout.jsp' style="font-size: 13px"><b>Logout</b></a></li>
	...
	<form action="inserttokenno.jsp" method="get" name="f1" 	onsubmit="return validation()">
			...
			<table><tr><td></td>
			<td align="right">
			<a href="showkoken_no.jsp"><p align="right" style="color: darkblue;float: left;">Show Token No.</p></a>
			<a href="selectoutlet.jsp"><p align="right" style="color: darkblue">Update Token No.</p></a></td></tr>
		<tr><td>	
			Select Merchant Name</td>
 ...
 while(rs.next()){
     ...
     %>
      ...
      <option value='-1'></option>  
					  ...
					  <tr><td>	
			Search Delivery Agent</td> <td><input type="text" name="name3"  class="input_text"  id="country3"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /><br><a href="addagent.jsp" style="color: darkblue"><p style="color: darkblue"> Add Delivery Agent</p></a></td></tr> <br />
					
					
		
					
					  <tr><td>	
			Enter Token No.</td> <td><input type="text" name="name4"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr> <br />
