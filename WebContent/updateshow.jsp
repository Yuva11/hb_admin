	...
	<form action="updatediscpuntcode.jsp" method="get" name="f1" 	onsubmit="return validation()">
			...
			<table>	
				...
				String type=request.getParameter("type");
					...
					ResultSet rs = null;
					String payuMoneyId=request.getParameter("id");
					try {
						ps = con.prepareStatement("SELECT  * FROM discountcoupon where id=?");
			...
			<tr>		
			<td>Enter coupon_code</td> <td><input type="text" name="name1" value="<%=rs.getString(2) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter percentage</td> <td><input type="text" name="name2" value="<%=rs.getString(3) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter max_value</td> <td><input type="text" name="name3" value="<%=rs.getString(4) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<tr>		
			<td>Enter start_date</td> <td> <input type="text" name="name4" <%-- value="<%=rs.getString(5) %>" --%> id="datepicker"
					style="width: 120px;" /><img src="images/ffffff.jpeg" height="25px"
					width="25px" style="margin-top: -9px;" /></td></tr>


						<tr>		
			<td>Enter end_date</td> <td> <input type="text" name="name5" <%-- value="<%=rs.getString(6) %>" --%> id="datepicker1"
					style="width: 120px;" /><img src="images/ffffff.jpeg" height="25px"
					width="25px" style="margin-top: -9px;" /></td></tr>
					
						<tr>		
			<td>Enter city</td> <td><input type="text" name="name6"  value="<%=rs.getString(7) %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
					 <br />
						<td>Search Merchant Branch Name</td> <td>
						 <select name='country' name="country" onchange="showState(this.value)" 
 ...
 */ Statement stmt = con.createStatement();  
 ResultSet rs1 = stmt.executeQuery("Select * from merchant");
 while(rs1.next()){
     %>
      <option value="<%=rs1.getString(1)%>"><%=rs1.getString(8)%></option>  
      <%
 }
     %>
      </select>  
	  ...
	  <tr><td>
			Select Outlet Name</td> <td> 
	  <div id='state'>  
      <select name='state'  style="width:150px;margin-left: 8px;" >  
       <option value='0'>-select-</option> 
      <option value='-1'></option>  
      </select>  
      </div>  </td></tr>
					
				<td>Enter Minimum Order value</td> <td><input type="text" name="name7" value="<%=rs.getString(9)%>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					<%long i=0L; %>
						<input type="hidden" name="name8" value="<%=i %>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" />
					
						<td>Enter Maximum usage</td> <td><input type="text" name="name9" value="<%=rs.getString(11)%>" class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" /></td></tr>
					
						<td>Select Coupon Code Type</td> <td>
							<select type="text" name="name10"  class="input_text"  
					style="width: 139px; padding: 4px;margin-bottom: 5px" >
					 <option value="-select coupon type--">-select coupon type--</option>
