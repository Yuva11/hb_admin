...
<body >
				...
				<%
	              ...
	              try
	              {
	      		ps3 = con.prepareStatement("select * from   deliveryagect where name=?");
				...
				System.out.print(e);
					...
					try {
						...
						ps = con.prepareStatement("update  newtokenno set  merchantname=?,merchant_id=?,merchantbranch_name=?,merchantbranch_id=?,agent_name=?,agent_id=?,token_no=? where  merchantbranch_id=?");
						ps.setString(1,mid);
						ps.setString(2,merchant_id);
						ps.setString(3,mbid);
						ps.setString(4,merchantbranch_id);
						ps.setString(5,agent);
						ps.setLong(6,aid);
						ps.setString(7,token);
						ps.setString(8,merchantbranch_id);
						ps.executeUpdate();
						con.close();
