...
<body >
				...
				<%
					...
					String ss1=request.getParameter("name2");
					String ss2=request.getParameter("name3");
					try {
						
						
						ps = con.prepareStatement("update merchantbranch set token_id=? where branch_name=?");
						ps.setString(1,ss);
						ps.setString(2,ss1);
	...
	<script>
       alert(' Token No Add For Merchant Branch');
