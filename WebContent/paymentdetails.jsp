...
<body onload="JavaScript:AutoRefresh(20000);">
   ...
   <strong><b style="font-family: serif;margin-top: 10px;font-size: 11px;"><img src="images/Delete_Icon.png" height="15x" width="20px"></img><a href="deletesearchproduct.jsp" style="padding: 8px;background-color: azure">Delete order</a></b></strong> -->
			...
			<form action="paymentdetail.jsp" method="post" name="f1"
				...
				<input type="text" name="payuMoneyId" id="country"
					class="input_text" style="width: 139px; padding: 4px;" /> <br />
			...
			<table style="float: left; margin-left: 4px;" width="750px"
				...
				<%
					PreparedStatement ps = null;
						...
						try {
							ps = con.prepareStatement("SELECT  * FROM newpayment where txnid=?");
							...
							if (rs.next()) {
								/* sd1=rs.getString(41);
								System.out.println("sd1="+rs.getString("payment_date"));
								sd2=sd1.substring(0,10);
								 */
				%>
				<tr>
					<td><%=count++%></td>
				...
				<%
								...
								try {
									String result = test
											.postDataRadRunn(
													gson.toJson(hm),
													"http://localhost:8090/HBAppService/getResponseFromPayuOnClick.do",
													"");
								...
								session.setAttribute("txnid", orderid);
								response.sendRedirect("paymentdetailss.jsp");
							}
